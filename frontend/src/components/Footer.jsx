...
export const Footer = () => {
  return (
    <footer className="bg-slate-900 text-slate-100 mt-12 sm:mt-16 lg:mt-24 border-t border-slate-800">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl sm:text-2xl font-bold text-white">StudentGigs</span>
            </div>
          ...
          {/* For Students */}
          <div>
            <h3 className="font-bold mb-4 sm:mb-5 text-base sm:text-lg" style={{ color: '#ffffff' }}>For Students</h3>
          ...
          {/* For Hirers */}
          <div>
            <h3 className="font-bold mb-4 sm:mb-5 text-base sm:text-lg" style={{ color: '#ffffff' }}>For Hirers</h3>
            <ul className="space-y-2 sm:space-y-3 text-sm">
          ...
          {/* Support */}
          <div>
            <h3 className="font-bold mb-4 sm:mb-5 text-base sm:text-lg" style={{ color: '#ffffff' }}>Support</h3>
            <ul className="space-y-2 sm:space-y-3 text-sm">
        ...
        {/* Bottom section */}
        <div className="mt-8 sm:mt-10 lg:mt-12 pt-6 sm:pt-8 border-t border-slate-800 text-center">
